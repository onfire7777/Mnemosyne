...
- `src/mnemosyne/consolidation.py` — warm-loop consolidation worker through the promotion gate with deterministic and command-backed entity resolution.
