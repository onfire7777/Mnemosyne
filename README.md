...
- `.venv/bin/python -m pytest -q` collects 300 tests and returns 261 passing tests plus 39 skipped live-DB tests when `MNEMOSYNE_POSTGRES_DSN` is unset.
