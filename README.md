...
- `.venv/bin/python -m pytest -q` collects 297 tests and returns 258 passing tests plus 39 skipped live-DB tests when `MNEMOSYNE_POSTGRES_DSN` is unset.
