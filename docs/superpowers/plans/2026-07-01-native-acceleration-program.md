...
|---|------|--------|----------|
| 0 | `2026-07-01-phase0-seam-hardening.md` | **READY** | — |
| 1 | `phase1-kernels.md` (C1 `mnemosyne._native` + A4 lazy imports) | to write | Phase 0 merged (kernel call sites = `algorithms.py` functions) |
| 2 | `phase2-sqlite-engine.md` (C2 + A1 cache + chaos harness + drift/ops-check/L4 suites) | to write | Phase 0 merged (ENGINE-CONTRACT, fixture parametrization, journal, registry) |
| 3 | `phase3-providers.md` (C3 sidecar + A3 consolidation ladder) | to write | Phase 0 merged; independent of 1–2 |
