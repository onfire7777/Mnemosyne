...
| 2 | `phase2-sqlite-engine.md` (C2 + A1 cache + chaos harness + drift/ops-check/L4 suites) | to write | Phase 0 complete on branch `phase0/seam-hardening` (merge pending) (ENGINE-CONTRACT, fixture parametrization, journal, registry) |
