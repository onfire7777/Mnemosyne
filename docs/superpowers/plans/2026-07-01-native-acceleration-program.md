...
| 3 | `phase3-providers.md` (C3 sidecar + A3 consolidation ladder) | **IN PROGRESS** on `phase3/providers-consolidation` (plan written; start at Task 1 contract pins) | Phase 2 exit gates are complete; provider work must preserve Phase 0/1/2 parity contracts and keep C4 evidence-gated |
