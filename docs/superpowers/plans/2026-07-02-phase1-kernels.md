...
1. `text.py:68` `cosine(a, b)` = `sum(x*y for x, y in zip(a, b, strict=False))` — sequential accumulation from 0.0, **silent truncation** to the shorter input.
