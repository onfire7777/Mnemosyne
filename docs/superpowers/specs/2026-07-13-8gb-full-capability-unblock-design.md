...
- **Immediately:** finish the remaining R1c rail/traceability reruns and land the rollback slice; prepare the human governance packet; complete compact-corpus planning and immutable-manifest preparation; establish a strong eval window without disrupting in-flight evidence.
