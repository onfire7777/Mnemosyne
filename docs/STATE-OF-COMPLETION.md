...
- **◷ Scope-deferred (blueprint non-goals):** FR-20 multimodal (N5 post-v1 — local image/audio/video breadth validated; production evidence still operator-run), FR-21 real LoRA (N2 optional, GPU).
