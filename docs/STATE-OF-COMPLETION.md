...
> **Status note (updated 2026-06-25).** This is a **historical Waves 1–3 scoreboard**, kept for lineage. For current completion status read **`docs/ROADMAP-TO-100.md`** (blended ~82%, mandatory Tier A wirings closed, 06-07 local/compose runtime readiness green, 06-08 local-staging evidence proof recorded, 06-09 operator-gate readiness complete) and the controlling **`.planning/STRICT-BLUEPRINT-PARITY-AUDIT.md`**. Since this scoreboard was written, the mandatory Tier A `src` reconciliation items (A1–A10, A13, A14) have all landed; historical strict-xfail source-gap notes below describe the 2026-06-21 state, not today.
