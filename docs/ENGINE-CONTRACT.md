...
closed before mutation. Listing is tenant-scoped; cancellation is tenant-scoped,
restricted to the owning user or agent, and idempotent.
...
|---|---|---|---|
| (k) prospective memory | `schedule_intention` / `cancel_intention` / `list_intentions` / `evaluate_due_intentions` | `schedule_intention` / `cancel_intention` / `list_intentions` / `evaluate_due_intentions` | `schedule_intention` / `cancel_intention` / `list_intentions` / `evaluate_due_intentions` |
