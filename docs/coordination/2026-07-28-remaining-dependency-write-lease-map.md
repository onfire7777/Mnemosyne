...
|---|---|---|---|---|---|
| T0 | ACTIVE | Canonical truth PR after PR #86; consumes exact-head CI `30559003114`, merge `661343ce`, manual run `30561430522`, and post-merge CI `30561266140` | Truthful GOAL/GSD lifecycle state and this current map | `GOAL.md`; `.planning/STATE.md`; `.planning/ROADMAP.md`; `.planning/REQUIREMENTS.md`; `.planning/phases/13-source-adapter-parity/13-01-PLAN.md`; `.planning/phases/13-source-adapter-parity/13-01-SUMMARY.md`; `docs/coordination/2026-07-28-remaining-dependency-write-lease-map.md`. GoalEx owner only | Normal PR #87 CI/review/merge/post-merge proof |
