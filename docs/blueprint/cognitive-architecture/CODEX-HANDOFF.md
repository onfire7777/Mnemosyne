...
- Prior pushed GitHub CI baseline `28341814283` passed on `b9ef75f`: Lint (ruff), Postgres integration, and Unit + drift checks completed successfully. Pair the local cleanup described above with the next pushed CI run after commit.
