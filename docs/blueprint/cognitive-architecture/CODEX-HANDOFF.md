...
- Pre-update verified source-bearing GitHub baseline, `1ce9641`, passed CI run `28371493805`: Lint (ruff), Postgres integration, Unit + drift checks, and G0 preregistration gate replay completed successfully. Newer commits supersede this line once their CI run passes.
