...
- Latest verified pushed GitHub baseline before this cleanup pass, `641ac7b`, passed CI run `28342563618`: Lint (ruff), Postgres integration, Unit + drift checks, and G0 preregistration gate replay completed successfully.
...
- Earlier pushed GitHub CI baseline `28341814283` passed on `b9ef75f`; it is superseded by current run `28342563618` on `641ac7b`.
