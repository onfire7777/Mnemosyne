...
- Current verified source-bearing GitHub baseline, `c0fd9ab`, passed CI run `28387648323`: Lint (ruff), Postgres integration, Unit + drift checks, and G0 preregistration gate replay completed successfully.
