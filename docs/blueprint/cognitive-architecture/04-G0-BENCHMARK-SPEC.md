...
- **Implemented slice:** schema-fast-path retrieval + evidence and projection-level reality-monitoring abstention + legacy/unclassified projection unknown-only abstention + retrieval-strengthening lifecycle marks + multi-signal write priority with trust-bounded importance-sampling debias + prediction-error-gated consolidation metadata + contested status for uncorroborated-but-congruent projections + the functional consciousness scorecard, reality-monitor seed, interoceptive proto-self, bounded cognitive cycle, workspace bottleneck, redacted workspace broadcast metadata in route/retrieval explain paths, workspace-to-consolidation advisory reports, explicit opt-in advisory promotion to prediction/replay inputs with tenant/source-CID validation and no direct mutation, explicit policy/request-gated retrieval-controller ranking promotion from CID-backed `workspace-retrieval-advisory.v1` metadata, specialist promotion-evidence reports with no gate result or promotion, dreamer replay gate, Standing byte-stable/continuous gates, the always-on heartbeat safety floor, the earned-autonomy credential gate with external-only, holdout-validated, provenance-domain, bounded/decay-ready credentials plus adversarial echo-chamber/sleeper coverage, the Phase 7 P5 cascade gate proving replayable Standing observability, erasure cascade to self-derivations, and belief-cascade Standing recompute metadata, and the Phase 7 P5 operational-toggle retirement gate proving the retired `service.enabled`, `SpecialistBudget.shadow_only`, and controller `budget.shadow_only` controls are absent while the fail-closed circuit breaker and separately gated advisory-promotion contracts remain present.
- **Preregistrations:** `eval/g0/preregistrations/g1-reliability-core-schema-fast-path.json`; `eval/g0/preregistrations/g1-write-priority-debias.json`; `eval/g0/preregistrations/g1-projection-reality-monitoring.json`; `eval/g0/preregistrations/g1-consciousness-scorecard.json`; `eval/g0/preregistrations/g1-reality-monitor-shadow-tags.json`; `eval/g0/preregistrations/g3-dreamer-shadow-ablation.json`; `eval/g0/preregistrations/g4-shadow-continuous-workspace-loop.json`; `eval/g0/preregistrations/g4-workspace-advisory-promotion-gate.json`; `eval/g0/preregistrations/g4-workspace-retrieval-controller-gate.json`; `eval/g0/preregistrations/g5-standing-byte-stable-parity.json`; `eval/g0/preregistrations/g5-standing-continuous.json`; `eval/g0/preregistrations/g5-always-on-heartbeat.json`; `eval/g0/preregistrations/g5-earned-autonomy.json`; `eval/g0/preregistrations/g5-unified-substrate-cascade.json`; `eval/g0/preregistrations/g5-toggle-retirement.json`.
