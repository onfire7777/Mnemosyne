...
**Location:** `docs/blueprint/cognitive-architecture/` · **Status:** G0 harness implemented; G1-G4 cognitive seeds plus Phase 7 plans 01-04 and P5 H8/H12 pre-check wired and gate-proven; explicit sanitized controller telemetry fixture available; Phase 7 toggle retirement and production/operator evidence remain pending · **Owner:** onfire7777 · **Updated:** 2026‑06‑27
