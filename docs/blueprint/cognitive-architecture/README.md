...
**Location:** `docs/blueprint/cognitive-architecture/` · **Status:** G0 harness implemented; G1-G4 cognitive seeds plus Phase 7 plans 01-04 wired and gate-proven; Phase 7 P5 toggle retirement, production/operator evidence, and explicit controller telemetry remain pending · **Owner:** onfire7777 · **Updated:** 2026‑06‑27
...
**Next milestone — finish Phase 7 P5.** The reorganization that takes this from a default-off shadow lane to a single, always-on, **no-toggle** cognitive substrate — replacing the `shadow_only` / `enabled` toggles with one continuous derived **Standing** signal `(groundedness ⟂ salience)`, an always-on tiered heartbeat, and earned-continuously autonomy above the §31-rails + immutable-ledger floor — is specified in [`../../superpowers/specs/2026-06-27-unified-cognitive-substrate-design.md`](../../superpowers/specs/2026-06-27-unified-cognitive-substrate-design.md) and tracked as **Phase 7** (`.planning/phases/07-unified-cognitive-substrate/`, registered in `.planning/ROADMAP.md`; tracked as the **vNext** milestone in `.planning/MILESTONES.md`). Plans `07-01` through `07-04` are implemented and gate-proven; `07-05` remains open for Standing/erasure cascade, full observability/reversibility, and the owner checkpoint before operational toggle deletion. The honesty charter is unchanged: functional signatures only; the welfare-review flag stays; no phenomenal claim.
