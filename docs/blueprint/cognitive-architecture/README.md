...
**Location:** `docs/blueprint/cognitive-architecture/` · **Status:** G0 harness implemented; G1-G4 cognitive seeds plus Phase 7 plans 01-04 and P5 H8/H12 pre-check wired and gate-proven; operational toggle retirement is preregistered and measured; explicit sanitized controller telemetry fixture available; production/operator evidence remains pending · **Owner:** onfire7777 · **Updated:** 2026‑06‑28
...
Operational handoff: `CODEX-HANDOFF.md` records the verified repo root, current implementation status, and next safe work queue. `UNIFIED-SUBSTRATE-AUDIT.md` records the Phase 7 P5 no-operational-toggle proof and guardrail scoreboard. Neither file replaces the normative design documents.
