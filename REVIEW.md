...
- Retrieval follow-up: HTTP-compatible embedding and reranker adapters now support production provider endpoints through CLI/env configuration while preserving deterministic defaults for local verification.
