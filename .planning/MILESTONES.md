...
- Current strict-continuation suite: `.venv/bin/python -m pytest -q` collects 292 tests and returns 253 passing tests plus 39 skipped live-DB tests when `MNEMOSYNE_POSTGRES_DSN` is unset.
