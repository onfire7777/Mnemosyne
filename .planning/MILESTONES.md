...
- Current strict-continuation suite: `.venv/bin/python -m pytest -q` collects 227 tests and returns 202 passing tests plus 25 skipped live-DB tests when `MNEMOSYNE_POSTGRES_DSN` is unset.
