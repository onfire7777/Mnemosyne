...
- Current strict-continuation suite: `.venv/bin/python -m pytest -q` collects 226 tests and returns 201 passing tests plus 25 skipped live-DB tests when `MNEMOSYNE_POSTGRES_DSN` is unset.
