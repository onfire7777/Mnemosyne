...
- [Observability]: CLI `ops-report` now exports dashboard-ready counts, queue state, learning diversity, proxy-vs-true gap, and tripwire status for a tenant; `--dashboard-html` writes a static dashboard artifact with a bounded JSON snapshot.
