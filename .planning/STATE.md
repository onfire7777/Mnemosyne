...
- Add production auth/session identity, deployment-grade authorization integration, crypto-shred/key-management policy, production C2PA trust validation, native image/audio embedding providers, production extractor deployment validation, and deployment observability.
