...
- Add production auth/session identity, branch/promotion authorization hardening, crypto-shred/key-management policy, production C2PA trust validation, native image/audio embedding providers, production extractor deployment validation, and deployment observability.
