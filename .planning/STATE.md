...
- [Consolidation]: Default local passes now execute summarizer, lesson_distiller, and skill_inducer roles for deterministic fact candidates; lessons/procedures persist through runtime learning state and are visible in `ops-report`.
