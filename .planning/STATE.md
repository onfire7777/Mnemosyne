...
- Add production auth/session identity, complete write-path authorization, crypto-shred/key-management policy, production C2PA trust validation, native image/audio embedding providers, production extractor deployment validation, and deployment observability.
