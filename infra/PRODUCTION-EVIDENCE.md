...
- `MNEMOSYNE_PROD_EVIDENCE_DIR`, `PREFLIGHT_OUT_ROOT`, and `OUT_ROOT` must be absolute external custody paths outside the repository; output roots must be new and must not already exist.
